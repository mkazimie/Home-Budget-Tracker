...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/static/css/401-error-styles.css"/>"/>
...
<h1>401</h1>
<h2> Not this time, request unauthorized!</h2>
<h2> <a href="/auth/budgets/"> Home </a></h2>
</body>
</html>